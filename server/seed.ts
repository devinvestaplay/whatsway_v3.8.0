  ...
  <div style="background:#fff;padding:24px;border-radius:0 0 8px 8px;border:1px solid #e5e7eb">
    ...
    const defaultProviders = [
      ...
      },
      {
        name: "Ziina",
        providerKey: "ziina",
        description: "Accept embedded checkout payments with Ziina",
        logo: "ziina",
        isActive: false,
        config: {},
        supportedCurrencies: PROVIDER_CURRENCY_OPTIONS.ziina,
        supportedMethods: PROVIDER_METHOD_OPTIONS.ziina,
      },
    ];
