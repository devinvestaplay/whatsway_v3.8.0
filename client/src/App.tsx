...
import ZiinaPaymentResult from "./pages/ZiinaPaymentResult";
import PricingPage from "./pages/PricingPage";
import StoresPage from "./pages/ecommerce/StoresPage";
...
const ROUTE_PERMISSIONS: Record<string, string> = {
  ...
  "/payment/success": "",
  "/payment-success": "",
  "/payment/ziina/success": "",
  "/payment/ziina/cancel": "",
  "/gateway": "",
  "/languages": "",
  "/team": "team.view",
...
function ImpersonationBanner() {
  ...
  const stopImpersonation = useMutation({
    mutationFn: () => apiRequest("POST", "/api/superadmin/white-label/impersonation/stop"),
    onSuccess: async (res: Response) => {
      const data = await res.json().catch(() => ({ redirectTo: "/white-label" }));
      queryClient.clear();
      window.location.href = data.redirectTo || "/white-label";
    },
  });
  ...
  return (
    <>
      ...
      <Switch>
        ...
        {marketingRoutes.map(({ path, component: Component }) => (
